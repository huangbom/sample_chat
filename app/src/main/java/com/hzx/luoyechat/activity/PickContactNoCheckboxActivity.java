...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		inflateContentView(R.layout.activity_pick_contact_no_checkbox,R.string.select_contacts,true);
...
//		}
	...
	private void getContactList() {
		...
		while (iterator.hasNext()) {
			...
			if (!entry.getKey().equals(Constant.NEW_FRIENDS_USERNAME) && !entry.getKey().equals(Constant.GROUP_USERNAME) && !entry.getKey().equals(Constant.CHAT_ROOM) && !entry.getKey().equals(Constant.CHAT_KEFU))
