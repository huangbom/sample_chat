...
public class BaiduMapActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inflateContentView(R.layout.activity_baidumap);

		setTitleAndNavigation(R.string.location_message, true);
...
//		sendButton.setVisibility(View.GONE);// TODO 1
...
//			sendButton.setEnabled(true); // TODO 2
...
//		menu.addSubMenu("second");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == R.id.btn_location_send){
