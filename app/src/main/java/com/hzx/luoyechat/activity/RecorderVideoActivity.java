...
public class RecorderVideoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		inflateContentView(R.layout.recorder_activity, R.string.recording_video,true);
...
//		}
	...
	public void onClick(View view) {
		...
		case R.id.recorder_stop:
			...
			showDialog(R.string.Whether_to_send, new DialogInterface.OnClickListener() {
				@Override
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			showDialog(st3, new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialogInterface, int i) {
					sendVideo(null);
				}
