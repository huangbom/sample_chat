...
public class ContactAdapter extends ArrayAdapter<User>  implements SectionIndexer{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置nick，里不涉及到完整user，用username代替nick显示
		...
		if(username.equals(Constant.NEW_FRIENDS_USERNAME)){
		    holder.nameTextview.setText(R.string.Application_and_notify);
			...
			//群聊item
		    holder.nameTextview.setText(R.string.group_chat);
		    holder.avatar.setImageResource(R.mipmap.group_icon);
		}else if(username.equals(Constant.CHAT_KEFU)){
            //群聊item
            holder.nameTextview.setText(R.string.robot_chat);
            holder.avatar.setImageResource(R.mipmap.kefu);
		} else{
