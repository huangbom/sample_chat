 ...
 */
package com.hzx.luoyechat.applib.utils;
...
public class HXPreferenceUtils {
	...
	public static final String MAINTAB_INDEX = "maintabindex";
	...
	public int getThemeColor(){
		return mSharedPreferences.getInt(THEME_COLOR,0);
	}

	public void setTabIndex(int index){
		editor.putInt(MAINTAB_INDEX,index);
		editor.commit();
	}

	public int getTabIndex(){
		return mSharedPreferences.getInt(MAINTAB_INDEX,0);
	}
